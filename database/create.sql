...
ALTER TABLE variable ADD FOREIGN KEY (variable_type_id) REFERENCES variable_type(id);
CREATE INDEX variable_object_type_id_idx ON variable(object_type_id);
ALTER TABLE variable ADD FOREIGN KEY (object_type_id) REFERENCES qcodo_class(id);
CREATE INDEX class_variable_qcodo_class_id_idx ON class_variable(qcodo_class_id);
ALTER TABLE class_variable ADD FOREIGN KEY (qcodo_class_id) REFERENCES qcodo_class(id);
CREATE INDEX class_variable_variable_group_id_idx ON class_variable(variable_group_id);
ALTER TABLE class_variable ADD FOREIGN KEY (variable_group_id) REFERENCES variable_group(id);
CREATE INDEX class_variable_protection_type_id_idx ON class_variable(protection_type_id);
ALTER TABLE class_variable ADD FOREIGN KEY (protection_type_id) REFERENCES protection_type(id);
CREATE INDEX class_variable_variable_id_idx ON class_variable(variable_id);
ALTER TABLE class_variable ADD FOREIGN KEY (variable_id) REFERENCES variable(id);
CREATE INDEX class_property_qcodo_class_id_idx ON class_property(qcodo_class_id);
ALTER TABLE class_property ADD FOREIGN KEY (qcodo_class_id) REFERENCES qcodo_class(id);
CREATE INDEX class_property_variable_group_id_idx ON class_property(variable_group_id);
ALTER TABLE class_property ADD FOREIGN KEY (variable_group_id) REFERENCES variable_group(id);
CREATE INDEX class_property_variable_id_idx ON class_property(variable_id);
ALTER TABLE class_property ADD FOREIGN KEY (variable_id) REFERENCES variable(id);
CREATE INDEX class_property_class_variable_id_idx ON class_property(class_variable_id);
ALTER TABLE class_property ADD FOREIGN KEY (class_variable_id) REFERENCES class_variable(id);
CREATE INDEX parameter_operation_id_idx ON parameter(operation_id);
ALTER TABLE parameter ADD FOREIGN KEY (operation_id) REFERENCES operation(id);
CREATE INDEX parameter_variable_id_idx ON parameter(variable_id);
ALTER TABLE parameter ADD FOREIGN KEY (variable_id) REFERENCES variable(id);
CREATE INDEX file_directory_id_idx ON file(directory_id);
ALTER TABLE file ADD FOREIGN KEY (directory_id) REFERENCES directory_token(id);
CREATE INDEX qcodo_class_parent_qcodo_class_id_idx ON qcodo_class(parent_qcodo_class_id);
ALTER TABLE qcodo_class ADD FOREIGN KEY (parent_qcodo_class_id) REFERENCES qcodo_class(id);
CREATE INDEX qcodo_class_interface_id_idx ON qcodo_class(interface_id);
ALTER TABLE qcodo_class ADD FOREIGN KEY (interface_id) REFERENCES qcodo_interface(id);
CREATE INDEX qcodo_class_class_group_id_idx ON qcodo_class(class_group_id);
ALTER TABLE qcodo_class ADD FOREIGN KEY (class_group_id) REFERENCES class_group(id);
CREATE INDEX qcodo_class_file_id_idx ON qcodo_class(file_id);
ALTER TABLE qcodo_class ADD FOREIGN KEY (file_id) REFERENCES file(id);
CREATE INDEX qcodo_interface_parent_qcodo_interface_id_idx ON qcodo_interface(parent_qcodo_interface_id);
ALTER TABLE qcodo_interface ADD FOREIGN KEY (parent_qcodo_interface_id) REFERENCES qcodo_interface(id);
CREATE INDEX qcodo_interface_class_group_id_idx ON qcodo_interface(class_group_id);
ALTER TABLE qcodo_interface ADD FOREIGN KEY (class_group_id) REFERENCES class_group(id);
CREATE INDEX qcodo_interface_file_id_idx ON qcodo_interface(file_id);
ALTER TABLE qcodo_interface ADD FOREIGN KEY (file_id) REFERENCES file(id);
CREATE INDEX qcodo_constant_qcodo_class_id_idx ON qcodo_constant(qcodo_class_id);
ALTER TABLE qcodo_constant ADD FOREIGN KEY (qcodo_class_id) REFERENCES qcodo_class(id);
CREATE INDEX qcodo_constant_variable_id_idx ON qcodo_constant(variable_id);
ALTER TABLE qcodo_constant ADD FOREIGN KEY (variable_id) REFERENCES variable(id);
CREATE INDEX qcodo_constant_file_id_idx ON qcodo_constant(file_id);
ALTER TABLE qcodo_constant ADD FOREIGN KEY (file_id) REFERENCES file(id);
CREATE INDEX operation_qcodo_class_id_idx ON operation(qcodo_class_id);
ALTER TABLE operation ADD FOREIGN KEY (qcodo_class_id) REFERENCES qcodo_class(id);
CREATE INDEX operation_qcodo_interface_id_idx ON operation(qcodo_interface_id);
ALTER TABLE operation ADD FOREIGN KEY (qcodo_interface_id) REFERENCES qcodo_interface(id);
CREATE INDEX operation_protection_type_id_idx ON operation(protection_type_id);
ALTER TABLE operation ADD FOREIGN KEY (protection_type_id) REFERENCES protection_type(id);
CREATE INDEX operation_return_variable_id_idx ON operation(return_variable_id);
ALTER TABLE operation ADD FOREIGN KEY (return_variable_id) REFERENCES variable(id);
CREATE INDEX operation_additional_variable_id_idx ON operation(additional_variable_id);
ALTER TABLE operation ADD FOREIGN KEY (additional_variable_id) REFERENCES variable(id);
CREATE INDEX operation_file_id_idx ON operation(file_id);
ALTER TABLE operation ADD FOREIGN KEY (file_id) REFERENCES file(id);
