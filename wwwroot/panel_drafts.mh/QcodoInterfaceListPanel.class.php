<?php
	// Include the classfile for QcodoInterfaceListPanelBase
	require(__PANELBASE_CLASSES__ . '/QcodoInterfaceListPanelBase.class.php');
	 ...
	 * abstract QcodoInterfaceListPanelBase class.
	 *
	 ...
	 * 
	 */
	class QcodoInterfaceListPanel extends QcodoInterfaceListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/QcodoInterfaceListPanel.tpl.php';
