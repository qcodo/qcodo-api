<?php
	// Include the classfile for VariableListPanelBase
	require(__PANELBASE_CLASSES__ . '/VariableListPanelBase.class.php');
	 ...
	 * abstract VariableListPanelBase class.
	 *
	 ...
	 * 
	 */
	class VariableListPanel extends VariableListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/VariableListPanel.tpl.php';
