<?php
	...
	$strPageTitle = $this->strTitleVerb . ' QcodoClass';
	require(__INCLUDES__ . '/header.inc.php')
?>

	<?php $this->RenderBegin() ?>
		<div class="title_action"><?php _p($this->strTitleVerb); ?></div>
		<div class="title"><?php _t('QcodoClass')?></div>
		<br class="item_divider" />

		<?php $this->lblId->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->lstParentQcodoClass->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->lstInterface->RenderWithName(); ?>
		<br class="item_divider" />
		...
		<?php $this->chkEnumerationFlag->RenderWithName(); ?>
		<br class="item_divider" />
