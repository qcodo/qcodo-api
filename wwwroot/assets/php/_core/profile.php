		...
		<table border="0" cellspacing="0" width="100%">
			<tr>
				...
				<td nowrap="nowrap" class="headingRight">
					<b>Database Index:</b> <?php _p($intDatabaseIndex); ?>;&nbsp;&nbsp;<b>Database Type:</b> <?php _p(QApplication::$ConnectionStringArray[$intDatabaseIndex]['adapter']); ?><br />
					<b>Database Server:</b> <?php _p(QApplication::$ConnectionStringArray[$intDatabaseIndex]['server']); ?>;&nbsp;&nbsp;<b>Database Name:</b> <?php _p(QApplication::$ConnectionStringArray[$intDatabaseIndex]['database']); ?><br />
