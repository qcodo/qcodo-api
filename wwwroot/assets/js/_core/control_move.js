...
//				this.registerDropZone(objTargetWrapper.parentNode);
			...
			objWrapper.moveMasks = function() {
				...
				if (blnValidDropZone)
					this.handle.style.cursor = "url(" + qcodo.imageAssets + "/_core/move_drop.cur), auto";
				else
					this.handle.style.cursor = "url(" + qcodo.imageAssets + "/_core/move_nodrop.cur), auto";
				...
				for (var strKey in this.moveControls) {
					...
					if (blnValidDropZone) {
						objMask.style.cursor = "url(" + qcodo.imageAssets + "/_core/move_drop.cur), auto";
					} else {
						objMask.style.cursor = "url(" + qcodo.imageAssets + "/_core/move_nodrop.cur), auto";
					}
				}
			}
