<?php
	 ...
	 * must create a new Form which extends this VariableEditFormBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class VariableEditFormBase extends QForm {
		...
		protected $lstClassProperty;
		protected $lstClassVariable;
		protected $lstParameter;
		protected $lstQcodoConstant;
		...
		protected function RedirectToListPage() {
			QApplication::Redirect('variable_list.php');
		}
	}
?>