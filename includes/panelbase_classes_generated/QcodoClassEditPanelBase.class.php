<?php
	 ...
	 * must create a new Panel which extends this QcodoClassEditPanelBase
	 * class.
	 *
	 ...
	 * 
	 */
	abstract class QcodoClassEditPanelBase extends QPanel {
		...
		public $lblId;
		public $lstParentQcodoClass;
		public $lstInterface;
		public $lstClassGroup;
		public $txtName;
		public $chkAbstractFlag;
		public $chkEnumerationFlag;
		...
		protected function SetupQcodoClass($objQcodoClass) {
			if ($objQcodoClass) {
