...
of the Qcodo codegen framework.
...
NOTE: the templates and subtemplates subdirectories are available for you
to place customizations to the templates and subtemplates themselves.  Read
the _README.txt files in either of those subdirectories to find out more.
