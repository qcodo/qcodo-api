	...
	qcodo.handleEvent = function(objEvent) {
		...
		*/
		if (window.document.compatMode == "BackCompat") {
			...
			qcodo.client.width = window.document.body.clientWidth;
			if (window.scrollMaxX)
				qcodo.client.height = window.document.body.clientHeight - window.scrollMaxY;
			else
				qcodo.client.height = window.innerHeight;
...
//		x: null,
//		y: null,
		width: window.document.body.scrollWidth - qcodo.client.width,
		height: window.document.body.scrollHeight - qcodo.client.height
//		width: null,
//		height: null
	}
