<?php
	// Include the classfile for DirectoryTokenListPanelBase
	require(__PANELBASE_CLASSES__ . '/DirectoryTokenListPanelBase.class.php');
	 ...
	 * abstract DirectoryTokenListPanelBase class.
	 *
	 ...
	 * 
	 */
	class DirectoryTokenListPanel extends DirectoryTokenListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/DirectoryTokenListPanel.tpl.php';
