<?php
	// Include the classfile for QcodoConstantListPanelBase
	require(__PANELBASE_CLASSES__ . '/QcodoConstantListPanelBase.class.php');
	 ...
	 * abstract QcodoConstantListPanelBase class.
	 *
	 ...
	 * 
	 */
	class QcodoConstantListPanel extends QcodoConstantListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/QcodoConstantListPanel.tpl.php';
