<?php
	// Include the classfile for ClassVariableListPanelBase
	require(__PANELBASE_CLASSES__ . '/ClassVariableListPanelBase.class.php');
	 ...
	 * abstract ClassVariableListPanelBase class.
	 *
	 ...
	 * 
	 */
	class ClassVariableListPanel extends ClassVariableListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/ClassVariableListPanel.tpl.php';
