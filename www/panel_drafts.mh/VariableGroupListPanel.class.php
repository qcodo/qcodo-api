<?php
	// Include the classfile for VariableGroupListPanelBase
	require(__PANELBASE_CLASSES__ . '/VariableGroupListPanelBase.class.php');
	 ...
	 * abstract VariableGroupListPanelBase class.
	 *
	 ...
	 * 
	 */
	class VariableGroupListPanel extends VariableGroupListPanelBase {
		// Specify the Location of the Template (feel free to modify) for this Panel
		protected $strTemplate = 'generated/VariableGroupListPanel.tpl.php';
