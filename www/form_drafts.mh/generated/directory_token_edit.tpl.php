<?php
	...
	$strPageTitle = $this->strTitleVerb . ' DirectoryToken';
	require(__INCLUDES__ . '/header.inc.php')
?>

	<?php $this->RenderBegin() ?>
		<div class="title_action"><?php _p($this->strTitleVerb); ?></div>
		<div class="title"><?php _t('DirectoryToken')?></div>
		...
		<?php $this->chkCoreFlag->RenderWithName(); ?>
		<br class="item_divider" />

		<?php $this->chkRelativeFlag->RenderWithName(); ?>
		<br class="item_divider" />
